...
X = data(:, 1:2); %size and number of bedroom
y = data(:, 3);%price
m = length(y); 
...
legend('Learning rate: 0.01', 'Learning rate: 0.05', 'Learning rate: 0.009');
...
% feature normalisation and using learned theta to predict
